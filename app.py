...
def generate_random_name():
    super_digits = '⁰¹²³⁴⁵⁶⁷⁸⁹'
    name = 'XR07' + ''.join(random.choice(super_digits) for _ in range(6))
    return name
...
#os.system('title GUEST GENERATOR v99 By XRSUPER ^| @XRSUPERIOT')
print('I DONT CARE ABOUT YOU IAM XR SUPERIOR')
print(f"""\n\n\n{Fore.RED+bold} 

  __   _______     _____ _    _ _____  ______ _____  _____ ____  _____   
 \ \ / /  __ \   / ____| |  | |  __ \|  ____|  __ \|_   _/ __ \|  __ \  
  \ V /| |__) | | (___ | |  | | |__) | |__  | |__) | | || |  | | |__) | 
   > < |  _  /   \___ \| |  | |  ___/|  __| |  _  /  | || |  | |  _  /  
  / . \| | \ \   ____) | |__| | |    | |____| | \ \ _| || |__| | | \ \  
 /_/ \_\_|  \_\ |_____/ \____/|_|    |______|_|  \_\_____\____/|_|  \_\ \n                                           {Fore.RED}@{Fore.RESET}XRSUPERIOR\n""")
...
for i in range(2000):
    with open('XRSUPERIOR07.txt','a') as file:
            try:
                r = create_acc(region)
                response = r['response']
                ...
                if status_code == 200:
                    ...
                    file.write(f"{uid}:{password}:{name}\n")
